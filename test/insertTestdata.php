...
$connection = new \PDO("mysql:host=localhost;dbname=autovermietung;", "root", "", array(
...
$tarife = "LOAD DATA LOCAL INFILE 'D:/STUDIUM/Semester/4/Module/DV Projekt/Projekt/testdata/tarife.xml'
INTO TABLE tarife
...
$kunden = "LOAD DATA LOCAL INFILE 'D:/STUDIUM/Semester/4/Module/DV Projekt/Projekt/testdata/kunden.xml'
INTO TABLE kunden
CHARACTER SET binary
LINES STARTING BY '<record>' TERMINATED BY '</record>'
(@record)
...
$mitarbeiter = "LOAD DATA LOCAL INFILE 'D:/STUDIUM/Semester/4/Module/DV Projekt/Projekt/testdata/mitarbeiter.xml'
...
$mietstationen = "LOAD DATA LOCAL INFILE 'D:/STUDIUM/Semester/4/Module/DV Projekt/Projekt/testdata/mietstationen.xml'
...
$kfztypen = "LOAD DATA LOCAL INFILE 'D:/STUDIUM/Semester/4/Module/DV Projekt/Projekt/testdata/kfztypen.xml'
INTO TABLE kfztypen
CHARACTER SET binary
LINES STARTING BY '<record>' TERMINATED BY '</record>'
(@record)
...
$kfzs = "LOAD DATA LOCAL INFILE 'D:/STUDIUM/Semester/4/Module/DV Projekt/Projekt/testdata/kfzs.xml'
INTO TABLE kfzs
CHARACTER SET binary
LINES STARTING BY '<record>' TERMINATED BY '</record>'
(@record)
...
$mietstationen_mietwagenbestaende = "LOAD DATA LOCAL INFILE 'D:/STUDIUM/Semester/4/Module/DV Projekt/Projekt/testdata/mietstationen_mietwagenbestaende.xml'
...
$reservierungen = "LOAD DATA LOCAL INFILE 'D:/STUDIUM/Semester/4/Module/DV Projekt/Projekt/testdata/reservierungen.xml'
...
$vertraege = "LOAD DATA LOCAL INFILE 'D:/STUDIUM/Semester/4/Module/DV Projekt/Projekt/testdata/vertraege.xml'
...
$mietvertraege = "LOAD DATA LOCAL INFILE 'D:/STUDIUM/Semester/4/Module/DV Projekt/Projekt/testdata/mietvertraege.xml'
...
$ruecknahmeprotokolle = "LOAD DATA LOCAL INFILE 'D:/STUDIUM/Semester/4/Module/DV Projekt/Projekt/testdata/ruecknahmeprotokolle.xml'
...
$connection->query($tarife);
$connection->query($kunden);
$connection->query($mitarbeiter);
$connection->query($mietstationen);
$connection->query($aktuellepersonalplaene);
$connection->query($kfztypen);
$connection->query($kfzs);
$connection->query($mietstationen_mietwagenbestaende);
$connection->query($reservierungen);
$connection->query($vertraege);
$connection->query($mietvertraege);
$connection->query($rechnungen);
$connection->query($ruecknahmeprotokolle);
?>