...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 23. Mai 2022 um 11:47
...
CREATE TABLE `mietstationen` (
  ...
  `stellplaetze` int(11) DEFAULT NULL,
...
CREATE TABLE `mietvertraege` (
  ...
  `mietdauerTage` int(11) DEFAULT NULL,
...
CREATE TABLE `rechnungen` (
  ...
  `mietvertragID` int(11) NOT NULL,
  `kundeID` int(11) NOT NULL,
  `rechnungDatum` date DEFAULT current_timestamp(),
...
CREATE TABLE `ruecknahmeprotokolle` (
  ...
  `ersteller` int(11) NOT NULL,
  `ruecknahmeDatum` date NOT NULL DEFAULT current_timestamp(),
  `tank` float NOT NULL,
  `sauberkeit` enum('sehr schmutzig','leicht schmutzig','neutral','sauber','sehr sauber') NOT NULL,
  `mechanik` varchar(45) NOT NULL,
